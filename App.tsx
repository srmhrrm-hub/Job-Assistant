...
import { AppState, GeneratedContent, SavedApplication, ChatMessage, TabView, Profile } from './types';
    ...
    <div className="h-screen flex flex-col bg-slate-950 text-slate-200 font-sans overflow-hidden">
      ...
      <header className="h-14 bg-slate-900 border-b border-slate-800 flex items-center justify-between px-6 shrink-0 z-20">
        <div className="flex items-center gap-3">
          ...
          <h1 className="font-semibold text-base text-slate-100 hidden md:block">Assistant Emploi</h1>
        </div>
      ...
      <main className="flex-1 overflow-hidden relative">
        ...
        {currentView === 'HISTORY' && (
            <div className="h-full overflow-y-auto custom-scrollbar max-w-5xl mx-auto">
                <h2 className="text-2xl font-bold text-white p-6 pb-0">Mes Candidatures</h2>
                <HistoryList 
                ...
                <div className="flex-1 bg-slate-950 h-full flex flex-col relative">
                    ...
                    {generatedData ? (
                        ...
                        <div className="h-full flex flex-col items-center justify-center text-slate-600 p-8 text-center">
                            ...
                            <h3 className="text-xl font-bold text-slate-500 mb-2">Espace de Travail</h3>
                            <p className="max-w-md">
                                Profil actif : <span className="text-blue-400 font-bold">{activeProfileName}</span>
                                <br/><br/>
                                Collez l'offre d'emploi à gauche pour commencer.
                            </p>
                        </div>
                    )}
                </div>
